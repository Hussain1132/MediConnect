...
const AppointmentForm = () => {
  ...
  const [doctorFirstName,setDocterFirstName]=useState("")
  const [doctorLastName,setDocterLastName]=useState("")
  ...
  const AppointmentHandler= async(e)=>{
        ...
        try{
            ...
            const {data}=await axios.post("/api/v1/appointment/post",{firstName,lastName,
                email,phone,
                nic,dob,gender,
                ...
                address,hasVisited:hasVisitedBool},{withCredentials:true,
                    headers:{
